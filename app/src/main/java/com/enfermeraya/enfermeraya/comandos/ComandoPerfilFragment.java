...
public class ComandoPerfilFragment {
    ...
    private ComandoPerfilFragment.OnPerfilChangeListener mListener;
    ...
    public ComandoPerfilFragment(ComandoPerfilFragment.OnPerfilChangeListener mListener){
     ...
     */
    private static ComandoPerfilFragment.OnPerfilChangeListener sDummyCallbacks = new ComandoPerfilFragment.OnPerfilChangeListener()
    {
